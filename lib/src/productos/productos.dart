...
class _ProductosState extends State<Productos> {
  ...
  Future<List> verProductos() async {
    var url = "http://152.172.138.103/pruebastesis/obtenerProducto.php";
    final response = await http.get(Uri.parse(url));
    return jsonDecode(response.body);
  }

  Future verCategoria() async {
    var url = "http://152.172.138.103/pruebastesis/verCategorias.php";
    final response = await http.get(Uri.parse(url));
  ...
  Future<List> filtroCategoria() async {
    var url =
        "http://152.172.138.103/pruebastesis/filtroCategorias.php?Categoria_id=$dropdownValue";
    final response = await http.get(Uri.parse(url));
  ...
  Future filtroNombre() async {
    ...
    var url =
        "http://152.172.138.103/pruebastesis/filtroNombre.php?Producto_nombre=$buscador";
    final response = await http.get(Uri.parse(url));
    return jsonDecode(response.body);
  }
